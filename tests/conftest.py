"""
Shared fixtures for the TA-airspace-watch integration suite.
...
Environment (defaults suit the docker harness):
  ...
  SPLUNK_CONTAINER  container name for     (default ta_airspace_watch_splunk)
...
CONTAINER = os.environ.get("SPLUNK_CONTAINER", "ta_airspace_watch_splunk")
